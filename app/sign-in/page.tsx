  ...
  return (
    <div className="academy-auth-page">
      <div className="academy-auth-card">
        ...
        <h1 className="academy-auth-title">Welcome back</h1>
        <p className="academy-auth-sub">Sign in to continue your training</p>
        ...
        <div className="academy-auth-divider"><span>or sign in with email</span></div>
        ...
        <form onSubmit={handleSubmit} className="academy-auth-form">
          ...
          <button type="submit" disabled={loading || googleLoad} className="academy-auth-submit">
            {loading ? <Loader2 className="auth-spinner" /> : "Sign In"}
          </button>
        </form>
      ...
      <style>{`
        .academy-auth-page {
          ...
          background: linear-gradient(135deg, #07182d 0%, #0e2a50 100%);
          padding: 24px;
        ...
        .academy-auth-google {
          ...
          padding: 12px; border: 1.5px solid #e2e8f0; border-radius: 12px; background: #fff;
          font-size: 0.9rem; font-weight: 600; color: #07182d; cursor: pointer; transition: all 0.2s;
        }
        ...
        .academy-auth-divider {
          display: flex; align-items: center; gap: 12px; margin: 20px 0;
          color: #94a3b8; font-size: 0.8rem;
        }
        .academy-auth-divider::before, .academy-auth-divider::after {
        ...
        .academy-input-wrap input {
          width: 100%; padding: 11px 40px 11px 38px; border: 1.5px solid #e2e8f0; border-radius: 10px;
          font-size: 0.9rem; color: #07182d; background: #f8fafc; outline: none; transition: border 0.2s;
        ...
        .academy-auth-submit {
          width: 100%; padding: 13px; background: linear-gradient(135deg, #c8a84b, #d4a017);
          border: none; border-radius: 12px; font-size: 0.95rem; font-weight: 700;
          color: #07182d; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px;
