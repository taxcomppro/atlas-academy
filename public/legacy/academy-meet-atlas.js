...
const titles = { dashboard: 'Academy Welcome', course: 'Welcome Player', downloads: 'Download Library', badges: 'Achievements', profile: 'My Profile' };
...
document.getElementById('backLesson01').addEventListener('click', () => { window.location.href = 'academy-welcome.html'; });
...
function renderState() {
  ...
  document.getElementById('completionHelp').textContent = state.completed
      ? '75 XP awarded. Your Academy Welcome is complete.'
  ...
  const courseProgress = state.completed ? 100 : 50;
  ...
  document.getElementById('moduleProgress').style.width = state.completed ? '100%' : '50%';
  ...
  document.getElementById('progressLabel').textContent = state.completed ? 'Academy Welcome complete' : 'Meet Atlas ready';
  document.getElementById('missionCount').textContent = state.completed ? '2 welcome missions complete' : '1 welcome mission complete';
...
document.getElementById('openLesson03').addEventListener('click', () => { if (state.completed) window.location.href = 'index.html'; });
